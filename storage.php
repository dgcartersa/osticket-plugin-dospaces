...
class S3StorageBackend extends FileStorageBackend {
    ...
    function __construct($meta) {
        ...
        $credentials['endpoint'] = "https://" . $credentials['aws-region'] . ".digitaloceanspaces.com";
...
class S3StoragePlugin extends Plugin {
    ...
    function bootstrap() {
        ...
        S3StorageBackend::$desc = sprintf('DO Spaces (%s)', $this->getConfig()->get('bucket'));
        FileStorageBackend::register('3', 'DOSpacesStorageBackend');
    }
}
